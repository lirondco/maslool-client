...
export default class NewTrailForm extends Component {
    ...
    handleSubmit = ev => {
        ...
        const { name, website, description, difficulty, safety, address_line, city, region, postal_code } = ev.target
