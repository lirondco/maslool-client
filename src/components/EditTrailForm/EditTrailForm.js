...
export default class EditTrailForm extends Component {
    ...
    handleDeleteTrail = ev => {
        ev.preventDefault()
        this.context.clearError()
        if (window.confirm("WARNING! This will delete this trail and all of its related components permanently. Do you wish to continue?")) {
    ...
    handleEditTrail = ev => {
        ...
        const { name, website, difficulty, description, safety, address_line, city, region, postal_code } = ev.target
    ...
    renderForm = () => {
        ...
        return (
            <>
                <form type='submit' className='edit_trail' onSubmit={this.handleEditTrail}>
                    <div className='main_form'>
                        <Label htmlFor='trail_name_edit'>
                            Trail Name:
                        </Label>
                        <Input
                            ref={this.firstInput}
                        ...
                        /><br />
                        <Label htmlFor='trail_website_edit'>
                            Website:
                        </Label>
                        <Input
                            ref={this.firstInput}
                        ...
                        /><br />
                        <Label htmlFor='trail_difficulty_edit'>
                            Difficulty:
                        </Label>
                        <select id='trail_difficulty_edit' name='difficulty' defaultValue={trail.difficulty}>
                        ...
                        <Label htmlFor='trail_description_edit'>
                            Trail Description:
                        </Label>
                        <Textarea
                        ...
                        /><br />
                        <Label htmlFor='location_address_edit'>
                            Address Line:
                        </Label>
                        <Input
                        ...
                        /><br />
                        <Label htmlFor='location_city_edit'>
                            City:
                        </Label>
                        <Input
                        ...
                        /><br />
                        <Label htmlFor='location_region_edit'>
                            Region or State:
                        </Label>
                        <Input
                        ...
                        /><br />
                        <Label htmlFor='location_postcode_edit'>
                            Postal Code:
                        </Label>
                        <Input
    ...
    render() {
        ...
        const sortedTrails = [...allTrails].sort((a, b) => (a.name > b.name) ? 1 : -1)
        return (
            <div className='EditTrailForm'>
                <form className='load_trail' type='submit' onSubmit={this.handleSelectTrail}>
                    <span className='select_trail'><Label htmlFor='edit_trail_select'>Select trail to edit: </Label>
                        <select id='edit_trail_select' name='trailId'>
                            {sortedTrails.map(trail =>
                                <option key={trail.id} value={trail.id}>{trail.name}</option>
                            )}
                        </select></span>
                    <Button type='submit'>Load Trail</Button><Button onClick={this.handleCancelClick}>Cancel Edit</Button>
                </form>
                {(this.state.trail) ? this.renderForm() : <p className='conditional_text'>Please select a trail to edit.</p>}
            </div>
        )
    }
}