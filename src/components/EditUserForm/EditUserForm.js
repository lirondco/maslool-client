    ...
    renderUserInfo = () => {
        return (
            <>
                ...
                {(this.state.isEditing) ? this.renderEditInterface() : <p>Email: <span>{this.state.user.email} </span><button onClick={this.handleEditClick} type='button' className='Edit_button'>[edit]</button></p>}
                <p>Member since: <span><NiceDate date={this.state.user.join_date} /></span></p>
            </>
        )
    }
