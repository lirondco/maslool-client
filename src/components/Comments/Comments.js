...
export default class Comments extends Component {
    ...
    renderButtons = (comment) => {
        return (
            <div className='comment_buttons'>
                <button className='edit_comment_button' onClick={e => this.handleEditActiveClick(comment, e)}>Edit</button>
                <button className='delete_comment_button' onClick={e => this.handleDelete(comment.id, e)}>Delete</button>
            </div>
        )
    }
    ...
    renderEditButtons = () => {
        return (
            <div className='comment_buttons'>
                <button type='submit' className='edit_comment_button'>Submit Edit</button>
                <button className='edit_comment_button' onClick={this.handleCancelEditClick}>Cancel</button>
            </div>
        )
    }
    ...
    render() {
        ...
        if (this.state.commentEdited === comment.id) {
            renderedContent = (
                <>
                    <form className='edit_comment' type='submit' onSubmit={e => this.handleEditSubmit(comment, e)}>
