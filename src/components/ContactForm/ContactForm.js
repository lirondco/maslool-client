...
export default class ContactForm extends Component {
    ...
    renderForm = () => {
        ...
        return (
            <>
            <p>From: <span className='username_contact'>{user.username}</span></p>
            <form type='submit' className='contact_form' onSubmit={this.handleSubmit}>
    ...
    renderSent = () => {
        ...
        return (
            <>
            <p>Thank you, <span className='username_contact'>{user.username}</span>. Your message was sent and we will contact your email that we have on file. Here's your message:</p>
            <div className='contact_form'>
                <p className='contact_form_message'>
                    {this.state.message}
                </p>
            </div>
            </>
